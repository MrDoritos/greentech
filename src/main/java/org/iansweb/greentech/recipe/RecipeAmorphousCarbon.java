...
public class RecipeAmorphousCarbon implements IRecipeInput {
	public RecipeAmorphousCarbon() {
		INPUTS = new ArrayList<ItemStack>();
		INPUTS.add(new ItemStack(ModItems.AMORPHOUS_CARBON));
	...
	public boolean matches(ItemStack subject) {
		...
		//return (subject.getItem().getUnlocalizedName() == ModItems.AMORPHOUS_CARBON.getUnlocalizedName());
		return (subject.isItemEqual(new ItemStack(ModItems.AMORPHOUS_CARBON)));
	}
